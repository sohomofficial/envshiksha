...
const DEFAULT_FEATURES: readonly Feature[] = [
  {
    ...
    description: "Discover how rising temperatures, melting ice, and extreme weather shape our world. Through interactive simulations and real-life examples, learn the science behind climate change and explore solutions to protect our planet.",
    image: "https://deifkwefumgah.cloudfront.net/shadcnblocks/block/placeholder-1.svg",
    width: 'large'
  },
  {
    title: "Waste Management",
    description: "Learn the importance of reducing, reusing, and recycling through fun mini-games and activities. Understand how proper waste management helps keep our environment clean and sustainable.",
    image: "https://deifkwefumgah.cloudfront.net/shadcnblocks/block/placeholder-2.svg",
    width: 'small'
  },
  {
    title: "Water Conservation",
    description: "Discover smart ways to save every drop through interactive tools and challenges. Track water usage, explore conservation techniques, and learn how small actions can make a big difference.",
    image: "https://deifkwefumgah.cloudfront.net/shadcnblocks/block/placeholder-1.svg",
    width: 'small'
  },
  {
    title: "Renewable Energy",
    description: "Explore the power of the sun, wind, and other clean sources through interactive simulations. Learn how renewable energy works and why it is key to building a sustainable future.",
    image: "https://deifkwefumgah.cloudfront.net/shadcnblocks/block/placeholder-2.svg",
    width: 'large'
  },
];
            ...
            {featurePairs.map(([first, second], index) => (
              <div 
                ...
                className={cn(
                  ...
                  index !== 0 && "border-t border-muted2 border-solid"
                )}
              >
                <FeatureCard
                  feature={first}
                  className="border-b border-muted2 border-solid lg:border-r lg:border-b-0"
                />
                {second && (
                  <FeatureCard 
                    feature={second}
